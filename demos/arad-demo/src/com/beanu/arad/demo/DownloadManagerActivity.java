...
import com.beanu.arad.utils.DownloadManagerPro;
...
public class DownloadManagerActivity extends BaseActivity {
	...
	private static final String KEY_NAME_DOWNLOAD_ID="download";
	...
	private void initData() {
		 ...
		 */
		downloadId=Arad.preferences.getLong(KEY_NAME_DOWNLOAD_ID);
//		downloadId = PreferencesUtils.getLongPreferences(context, KEY_NAME_DOWNLOAD_ID);
		updateView();
...
//				PreferencesUtils.putLongPreferences(context, PreferencesUtils.KEY_NAME_DOWNLOAD_ID, downloadId);
				Arad.preferences.putLong(KEY_NAME_DOWNLOAD_ID, downloadId);
