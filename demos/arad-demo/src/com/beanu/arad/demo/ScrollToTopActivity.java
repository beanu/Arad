...
public class ScrollToTopActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.scroll_to_top_activity);
	...
	public class CheesesAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				convertView = getLayoutInflater().inflate(R.layout.scroll_to_top_text_item, parent, false);
			}
	...
	public static final String CHEESES[] = { "Abbaye de Belloc", "Abbaye du Mont des Cats", "Abertam", "Abondance",
