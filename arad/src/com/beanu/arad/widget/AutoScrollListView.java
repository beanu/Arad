 ...
 * 
 * @see https://github.com/android/platform_packages_apps_contacts/blob/
 *      master/src/com/android/contacts/widget/AutoScrollListView.java
 * 
 *      <p/>
 * @see http://cyrilmottier.com/2013/01/09/back-to-top-android-vs-ios/
 */
