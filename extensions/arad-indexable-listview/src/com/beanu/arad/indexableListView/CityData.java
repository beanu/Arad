...
import com.beanu.arad.indexableListView.widget.pinyin.PinYin;
...
public class CityData {
    ...
    public static List<ContactItemInterface> getSampleContactList() {
        ...
        try {
            ...
            list.add(new CityItem("北京", "#"));
            list.add(new CityItem("上海", "#"));
            list.add(new CityItem("广州", "#"));
            list.add(new CityItem("武汉", "#"));
            list.add(new CityItem("成都", "#"));
            list.add(new CityItem("杭州", "#"));
            list.add(new CityItem("深圳", "#"));
            list.add(new CityItem("西安", "#"));
