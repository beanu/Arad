 ...
 * 带有两列的选择
 */
public abstract class SelectorTwoPopUpWindow {
    ...
    public interface OnSelectedListener {
        public void onSelected(int leftPosition, int rightPosition);
    ...
    protected abstract void updateRightData(SimpleAdapter rightAdapter, int position);


    public SelectorTwoPopUpWindow(Context ctx) {
        this.context = ctx;
    ...
    private void initView() {
        ...
        listLeft.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (listener != null) {
                    listener.onSelected(position, -1);
                }
                updateRightData(rightAdapter, leftSelectedPoint);
            }
        });
        ...
        listRight.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (listener != null) {
                    listener.onSelected(leftSelectedPoint, position);
                }
            }
        });
