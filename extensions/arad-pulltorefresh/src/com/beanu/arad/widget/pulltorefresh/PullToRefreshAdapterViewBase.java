...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements
	 ...
	 * {@link org.qii.weiciyuan.support.lib.pulltorefresh.PullToRefreshBase.Mode#PULL_DOWN_TO_REFRESH}
	 * . The default value is {@value #DEFAULT_SHOW_INDICATOR}.
	 * 
	...
	protected void resetSavedLastVisibleIndex() {
	 ...
	 * {@link org.qii.weiciyuan.support.lib.pulltorefresh.PullToRefreshBase#getRefreshableView()
	 * getRefreshableView()}.
	 * {@link android.widget.AdapterView#setAdapter(android.widget.ListAdapter)
	...
	protected void handleStyledAttributes(TypedArray a) {
		...
		mShowIndicator = a.getBoolean(R.styleable.PullToRefreshListView_ptrShowIndicator, DEFAULT_SHOW_INDICATOR);
	}
...
//		FrameLayout refreshableViewWrapper = getRefreshableViewWrapper();
		...
		// params.rightMargin =
		// getResources().getDimensionPixelSize(R.dimen.indicator_right_padding);
